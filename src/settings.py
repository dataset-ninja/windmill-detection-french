...
##################################
PROJECT_NAME: str = "Windmill Detection on French Aerial Images"
...
HOMEPAGE_URL: str = (
    "https://www.kaggle.com/datasets/mzellou/windmill-detection-on-french-aerial-images"
)
...
DOWNLOAD_ORIGINAL_URL: Optional[Union[str, dict]] = (
    "https://www.kaggle.com/datasets/mzellou/windmill-detection-on-french-aerial-images/download?datasetVersionNumber=1"
)
...
REPOSITORY: Optional[Union[str, List[str], Dict[str, str]]] = {
    "GitLab": "https://gitlab.com/MZellou1/eolienne_detection"
}

CITATION_URL: Optional[str] = None
AUTHORS: Optional[List[str]] = ["Marouane Zellou"]
